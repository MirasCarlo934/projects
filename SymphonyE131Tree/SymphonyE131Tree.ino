...
void setup() {
	...
	product.addProperty(Universe, "0060", false, SymphProduct::createGui(SLIDER_OUT,"Set Universe",0, 10, myUniverse));
	product.addProperty(start, "0059", false, SymphProduct::createGui(RADIO_OUT,"Start",0, 1, 1));
	product.addProperty(stop, "0058", false, SymphProduct::createGui(RADIO_OUT,"Stop",0, 1, 0));
	product.addProperty(3, "0057", false, SymphProduct::createGui(RADIO_OUT,"A",0, 1, 0));
	product.addProperty(4, "0056", false, SymphProduct::createGui(RADIO_OUT,"B",0, 1, 0));
			...
			if ( e131.universe == myUniverse) {
				for (int i = 0; i < NUM_PIXELS; i++) {
					for (int k=0; k< LED_STRINGS;k++) {
						...
						leds[k][i].setRGB(e131.data[j], e131.data[j+1], e131.data[j+2]);
					}
				}
				FastLED.show();
			}
