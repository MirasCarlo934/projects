...
import bm.smarthome.devices.products.*;
...
import bm.smarthome.properties.PropertyValueType;
...
//	}
	...
	public void retrievePropertyTypes() {
		...
		RawDBEReq request = new RawDBEReq(idg.generateERQSRequestID(), getPropertyTypesQuery);
		Object o;
		try {
			o = dbe.forwardRequest(request, Thread.currentThread(), true);
		} catch (EngineException e1) {
